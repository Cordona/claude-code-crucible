...
*Pair with: standard-clean-code, standard-self-documenting-code, standard-observability, standard-performance, standard-security, standard-testing (the WHAT) + build-report-standards (the report). Constructive twin of: review-core.*
