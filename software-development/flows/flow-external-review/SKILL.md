...
**step-verifier** (`general-purpose`) returns ONLY an object conforming to `$HOME/.claude/crucible/contracts/external-review-step-verifier.schema.json` (framework source: software-development/contracts/external-review-step-verifier.schema.json).
