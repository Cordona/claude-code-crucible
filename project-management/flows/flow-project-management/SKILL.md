...
- **Q0 — Tracker** *(only when unresolved by Tracker selection)* · Header "Tracker" · *"Which tracker does this go to?"* · options: **GitHub** (an issue in a repo) · **GitLab** (an issue in a project) · **Jira** (a ticket — the site is confirmed later, at the write gate).
